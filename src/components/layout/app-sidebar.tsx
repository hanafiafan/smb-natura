...
import { LayoutDashboard, ReceiptText, FileBarChart, Sparkles, MoreHorizontal, Leaf, Building2, Wallet, BookOpen, Package, Target, Layers } from "lucide-react";
...
const NAV_MAIN: NavItem[] = [
  ...
  { name: "Semua Brand", path: "/semua-brand", icon: <Layers size={20} /> },
